...
from src.rl.gym.observers import GlobalObserver, GlobalImageObserver
...
env = HeuristicsSpeedEnv(width=16, height=16, observer=GlobalImageObserver(nb_agents=2, width=16, height=16),
                         agent_classes=[AgentDummy, OneStepSurvivalAgent])
model = DQN("CnnPolicy", env, verbose=1, buffer_size=erm_size, target_network_update_freq=50, exploration_fraction=0.5,
